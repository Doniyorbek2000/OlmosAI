...
import { Boxes, LayoutDashboard, Coins, FolderOpen, Wand2, LogOut, Image as ImageIcon, Type, CreditCard, KeyRound, Shield, PersonStanding, Globe, Settings, LayoutGrid } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/api-keys', label: 'Developer', icon: KeyRound },
